...
const warehouse_group_schema_1 = require("./schemas/warehouse-group.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: warehouse_group_schema_1.WarehouseGroup.name, schema: warehouse_group_schema_1.WarehouseGroupSchema },
            ]),
        ],
